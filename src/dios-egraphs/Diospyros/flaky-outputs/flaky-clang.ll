...
204:                                              ; preds = %184
  ...
  %206 = call float @llvm.sqrt.f32(float %205) #8
...
269:                                              ; preds = %249
  ...
  %271 = call float @llvm.sqrt.f32(float %270) #8
...
define void @no_opt_naive_fixed_qr_decomp(float* %0, float* %1, float* %2) #1 {
  ...
  %38 = call i8* @__memcpy_chk(i8* %32, i8* %34, i64 16, i64 %37) #8
  %39 = call i8* @calloc(i64 4, i64 4) #9
...
118:                                              ; preds = %83
  ...
  %129 = sext i32 %128 to i64
  %130 = call i8* @calloc(i64 4, i64 %129) #9
  %131 = bitcast i8* %130 to float*
  store float* %131, float** %17, align 8
  %132 = load i32, i32* %11, align 4
  %133 = sext i32 %132 to i64
  %134 = call i8* @calloc(i64 4, i64 %133) #9
...
236:                                              ; preds = %192
  %237 = call i8* @calloc(i64 4, i64 4) #9
...
293:                                              ; preds = %290
  ...
  %301 = call i8* @__memcpy_chk(i8* %295, i8* %297, i64 16, i64 %300) #8
...
305:                                              ; preds = %290
  %306 = call i8* @calloc(i64 4, i64 4) #9
  ...
  %318 = call i8* @__memcpy_chk(i8* %312, i8* %314, i64 16, i64 %317) #8
  ...
  %329 = call i8* @__memcpy_chk(i8* %323, i8* %325, i64 16, i64 %328) #8
  br label %330
...
30:                                               ; preds = %17
  %31 = bitcast [4 x float]* %5 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %31, i8 0, i64 16, i1 false)
  %32 = bitcast [4 x float]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %32, i8 0, i64 16, i1 false)
  %33 = getelementptr inbounds [4 x float], [4 x float]* %3, i64 0, i64 0
  %34 = getelementptr inbounds [4 x float], [4 x float]* %5, i64 0, i64 0
  %35 = getelementptr inbounds [4 x float], [4 x float]* %6, i64 0, i64 0
  call void @naive_fixed_qr_decomp(float* %33, float* %34, float* %35)
  %36 = bitcast [4 x float]* %7 to i8*
  ...
  %38 = getelementptr inbounds [4 x float], [4 x float]* %3, i64 0, i64 0
  %39 = getelementptr inbounds [4 x float], [4 x float]* %7, i64 0, i64 0
  %40 = getelementptr inbounds [4 x float], [4 x float]* %8, i64 0, i64 0
  call void @no_opt_naive_fixed_qr_decomp(float* %38, float* %39, float* %40)
  store i32 0, i32* %9, align 4
  br label %41
...
48:                                               ; preds = %45
  ...
  %54 = getelementptr inbounds [4 x float], [4 x float]* %5, i64 0, i64 %53
  %55 = load float, float* %54, align 4
  %56 = fpext float %55 to double
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), double %56)
  %58 = load i32, i32* %9, align 4
  %59 = mul nsw i32 %58, 2
  %60 = load i32, i32* %10, align 4
  %61 = add nsw i32 %59, %60
  %62 = sext i32 %61 to i64
  %63 = getelementptr inbounds [4 x float], [4 x float]* %7, i64 0, i64 %62
  %64 = load float, float* %63, align 4
  %65 = fpext float %64 to double
  %66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), double %65)
  ...
  %78 = fcmp olt double %77, 0x3FB99999A0000000
  %79 = xor i1 %78, true
...
83:                                               ; preds = %48
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i64 0, i64 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 300, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.3, i64 0, i64 0)) #10
  unreachable
...
102:                                              ; preds = %99
  ...
  %108 = getelementptr inbounds [4 x float], [4 x float]* %6, i64 0, i64 %107
  ...
  %117 = getelementptr inbounds [4 x float], [4 x float]* %8, i64 0, i64 %116
  %118 = load float, float* %117, align 4
  %119 = fpext float %118 to double
  %120 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i64 0, i64 0), double %119)
  %121 = load i32, i32* %11, align 4
  %122 = sext i32 %121 to i64
  %123 = getelementptr inbounds [4 x float], [4 x float]* %8, i64 0, i64 %122
  %124 = load float, float* %123, align 4
  %125 = load i32, i32* %11, align 4
  %126 = sext i32 %125 to i64
  %127 = getelementptr inbounds [4 x float], [4 x float]* %6, i64 0, i64 %126
  %128 = load float, float* %127, align 4
  %129 = fsub float %124, %128
  %130 = fpext float %129 to double
  %131 = call double @llvm.fabs.f64(double %130)
  %132 = fcmp olt double %131, 0x3FB99999A0000000
  %133 = xor i1 %132, true
...
137:                                              ; preds = %102
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i64 0, i64 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 307, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.6, i64 0, i64 0)) #10
  unreachable
